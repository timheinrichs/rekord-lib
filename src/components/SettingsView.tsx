        ...
        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <label className="flex flex-col gap-1 text-sm">
            ...
            <select
              ...
              className="rounded-md border border-border-strong bg-surface-2 px-3 py-2 focus:border-accent-500"
            >
          ...
          <label className="flex flex-col gap-1 text-sm">
            ...
            <select
              ...
              className="rounded-md border border-border-strong bg-surface-2 px-3 py-2 focus:border-accent-500 disabled:border-border disabled:text-fg-disabled"
            >
      ...
      <section className="rounded-xl border border-border bg-surface p-5">
        ...
        <label className="mt-4 flex flex-col gap-1 text-sm">
          ...
          <select
            ...
            className="w-64 rounded-md border border-border-strong bg-surface-2 px-2 py-1.5 text-fg focus:border-accent-500"
          >
