...
/** Six dots: the handle a row is picked up by. */
...
/**
 * Scan — a viewfinder with a line sweeping through it.
 *
 * Deliberately not a circling arrow: the library scan reads and analyses files,
 * it does not reload a page, and a refresh glyph promised the wrong thing.
 */
...
/** Needs conversion — two arrows swapping, as in "re-encode". */
...
/** Event log: lines of recorded activity. */
...
/** Add: the one thing a plus can mean. */
...
/** Out to the corners: open the track on a surface of its own. */
