...
| [PLAYBACK.md](PLAYBACK.md) | Playing a track: the two waveform resolutions and why only one is stored, the surface that zooms in, and the beat grid — drawn, movable, and stored where a rescan cannot reach it |
