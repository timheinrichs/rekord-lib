...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::edit_set,
            commands::edit_clear,
            commands::grid_edits_load,
            commands::grid_edit_set,
            commands::grid_edit_clear,
            ...
            commands::set_discogs_app_credentials,
